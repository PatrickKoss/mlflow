...
- [ ] T-S5 Assistant claude_code invocation parity (stdin message + system-prompt temp file)
...
- [ ] T-S6 Online scoring: trace completion buffer for the trace scoring window
