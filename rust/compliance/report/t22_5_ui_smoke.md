...
| Gateway endpoint guardrails | `#/gateway/endpoints/e-fbca70aa52d2444eb1fe76c072a0c9b1?tab=guardrails` | Endpoint detail Guardrails tab and seeded guardrail rendered; zero Python-attributed responses. | **PASS** | `gateway-guardrails.png` | Guardrail was attached through Rust RPCs; no model invocation occurred. |
...
| Issues | `#/experiments/1/evaluation-runs/862ea939e8364364a19b8d7a097408fc/issues` | Issue-detection run Issues tab and seeded run-linked issue rendered; zero Python-attributed responses. | **PASS** | `issues.png` | Populated pending issue state. |
...
| Dataset records | `#/experiments/1/datasets/d-45266b1926bb4840a60d442f2da143c9` | Dataset detail and populated records table rendered; zero Python-attributed responses. | **PASS** | `dataset-records.png` | Two deterministic records, one linked to a seeded trace. |
