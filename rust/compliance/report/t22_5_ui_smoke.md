...
| Gateway endpoint guardrails | `#/gateway/endpoints/e-d3dd995e36014e1081cf2bdc8b3b3d66?tab=guardrails` | Endpoint detail Guardrails tab and seeded guardrail rendered; zero Python-attributed responses. | **PASS** | `gateway-guardrails.png` | Guardrail was attached through Rust RPCs; no model invocation occurred. |
...
| Issues | `#/experiments/1/evaluation-runs/8c5b26eefe5748b38eeed2802ebf2171/issues` | Issue-detection run Issues tab and seeded run-linked issue rendered; zero Python-attributed responses. | **PASS** | `issues.png` | Populated pending issue state. |
...
| Dataset records | `#/experiments/1/datasets/d-ec9372974cd6438dbb83b603e47dc9e4` | Dataset detail and populated records table rendered; zero Python-attributed responses. | **PASS** | `dataset-records.png` | Two deterministic records, one linked to a seeded trace. |
...
| Review queues | `#/experiments/1/review-queue?selectedQueueId=rq-a6f2c508ee804dd48dda28e1d6adc62c` | Selected populated review queue and pending trace rendered; zero Python-attributed responses. | **PASS** | `review-queues.png` | Populated custom queue state. |
| Labeling / focused review | `#/experiments/1/review-queue?selectedQueueId=rq-a6f2c508ee804dd48dda28e1d6adc62c&selectedItemId=tr-11111111111111111111111111111111` | FocusedReview rendered the trace and label-schema question controls; zero Python-attributed responses. | **PASS** | `labeling.png` | Read-only browser smoke; it does not mutate the seeded answer. |
