...
| Logged model detail | `#/experiments/1/models/m-594390d78fce40fc81bce274de54ba2e` | The finalized model detail rendered its ID, name, status, and parameters. Zero Python-attributed responses and no unexpected failed same-origin response. | **PASS** | `part1-logged-model-detail.png` | Populated finalized state. |
| Datasets dropdown + records | `#/experiments/1/datasets/d-45266b1926bb4840a60d442f2da143c9` | The experiment Datasets navigation and populated dataset records rendered. Zero Python-attributed responses and no unexpected failed same-origin response. | **PASS** | `dataset-records.png` | Shared with the T22.5 test; intentionally not duplicated. |
