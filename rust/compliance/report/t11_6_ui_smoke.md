...
| Logged model detail | `#/experiments/1/models/m-d2d0facdac40425984288d6a8f4c41d5` | The finalized model detail rendered its ID, name, status, and parameters. Zero Python-attributed responses and no unexpected failed same-origin response. | **PASS** | `part1-logged-model-detail.png` | Populated finalized state. |
| Datasets dropdown + records | `#/experiments/1/datasets/d-f71b68882ee44683a785901b64269dfb` | The experiment Datasets navigation and populated dataset records rendered. Zero Python-attributed responses and no unexpected failed same-origin response. | **PASS** | `dataset-records.png` | Shared with the T22.5 test; intentionally not duplicated. |
