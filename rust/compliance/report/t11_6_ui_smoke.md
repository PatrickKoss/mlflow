...
| Logged model detail | `#/experiments/1/models/m-fd0512174557437fb966fd33c026af01` | The finalized model detail rendered its ID, name, status, and parameters. Zero Python-attributed responses and no unexpected failed same-origin response. | **PASS** | `part1-logged-model-detail.png` | Populated finalized state. |
| Datasets dropdown + records | `#/experiments/1/datasets/d-ec9372974cd6438dbb83b603e47dc9e4` | The experiment Datasets navigation and populated dataset records rendered. Zero Python-attributed responses and no unexpected failed same-origin response. | **PASS** | `dataset-records.png` | Shared with the T22.5 test; intentionally not duplicated. |
