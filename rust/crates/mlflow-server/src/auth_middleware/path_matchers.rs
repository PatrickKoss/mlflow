...
fn proto_validator(service: &str, method: &str) -> Option<Validator> {
    ...
    let v = match (service, method) {
        ...
        // ---- AI Gateway ----
        ("MlflowService", "getGatewaySecretInfo") => ReadGatewaySecret,
        ("MlflowService", "updateGatewaySecret") => UpdateGatewaySecret,
        ("MlflowService", "deleteGatewaySecret") => DeleteGatewaySecret,
        ("MlflowService", "createGatewayEndpoint") => CreateGatewayEndpoint,
        ("MlflowService", "getGatewayEndpoint") => ReadGatewayEndpoint,
        ("MlflowService", "updateGatewayEndpoint") => UpdateGatewayEndpoint,
        ("MlflowService", "deleteGatewayEndpoint") => DeleteGatewayEndpoint,
        ("MlflowService", "createGatewayModelDefinition") => CreateGatewayModelDefinition,
        ...
        ("MlflowService", "deleteEndpointBinding") => UpdateGatewayEndpoint,
        ("MlflowService", "listEndpointBindings") => ReadGatewayEndpoint,
        ("MlflowService", "setGatewayEndpointTag") => UpdateGatewayEndpoint,
        ("MlflowService", "deleteGatewayEndpointTag") => UpdateGatewayEndpoint,
