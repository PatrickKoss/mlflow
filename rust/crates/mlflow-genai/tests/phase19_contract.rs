...
fn execution_rejections_match_python_messages() {
    ...
    assert_eq!(
        ...
        "Failed to load scorer 'x'. The scorer is serialized in an unknown format that cannot be deserialized. Please make sure you are using a compatible MLflow version or recreate the scorer. Scorer was created with MLflow version: 3.15.3.dev0, serialization version: 1, current MLflow version: 3.15.3.dev0."
    );
}
